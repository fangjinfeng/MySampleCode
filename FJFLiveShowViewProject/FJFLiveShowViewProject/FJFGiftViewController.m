...
// vc
#import "FJFGiftViewController.h"

@interface FJFGiftViewController ()
// giftContainerView
@property (nonatomic, strong) FJFLiveAnimationContainerView *giftContainerView;
@end

@implementation FJFGiftViewController
...
- (void)mySameGiftButtonClicked:(UIButton *)sender {
    ...
    tmpModel.backImageName = @"fjf_anchor_gift_normal_icon";
...
- (void)otherSameGiftButtonClicked:(UIButton *)sender {
    sender.tag ++;
    FJFLiveGiftShowModel *tmpModel = [[FJFLiveGiftShowModel alloc] init];
    tmpModel.backImageName = @"fjf_anchor_gift_knight_icon";
