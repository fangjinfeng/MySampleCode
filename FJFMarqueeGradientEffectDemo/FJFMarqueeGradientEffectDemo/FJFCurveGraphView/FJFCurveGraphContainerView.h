...
// curveGraphViewStyle
@property (nonatomic, strong, readonly) FJFCurveGraphViewStyle *curveGraphViewStyle;
// backgroundViewStyle
@property (nonatomic, strong, readonly) FJFCurveGraphBackgroundViewStyle *backgroundViewStyle;
/// 更新 viewControls
