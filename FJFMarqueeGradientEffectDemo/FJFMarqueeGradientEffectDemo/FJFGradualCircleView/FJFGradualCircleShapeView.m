...
- (void)updateViewControls {
    [self.gradientLayerArray enumerateObjectsUsingBlock:^(CAGradientLayer * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
       [self circlePositionWithLayerPosition:idx isClockwise:_shapeViewStyle.isClockwise positionBlock:^(CGPoint startPoint, CGPoint endPoint, NSArray *colorArray) {
    ...
    self.progressLayer.lineWidth = _shapeViewStyle.lineWidth;
}
